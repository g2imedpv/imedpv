...
class SdXmlStructuresController extends AppController
{
    ...
    */
    ...
    public function clinical($caseId){   //genXMLThree
        $this->autoRender = false;
        //set file name with caseNo and create time
        $sdCases = TableRegistry::get('sdCases');
        $name=$sdCases->find()
    ...
    public function numFollowup($caseId){
        $this->autoRender = false;
        //set file name with caseNo and create time
        $sdCases = TableRegistry::get('sdCases');
        $name=$sdCases->find()
    ...
    public function numInitial($caseId){   //genXMLThree
        $this->autoRender = false;
        //set file name with caseNo and create time
        $sdCases = TableRegistry::get('sdCases');
        $name=$sdCases->find()
    ...
    public function nullification($caseId){   //genXMLThree
        $this->autoRender = false;
        //set file name with caseNo and create time
        $sdCases = TableRegistry::get('sdCases');
        $name=$sdCases->find()
    ...
    public function getSetnum($caseId,$fieldId){

    }
    public function genXMLThree($caseId){   //genXMLThree
        $this->autoRender = false;
        //set file name with caseNo and create time
        $sdCases = TableRegistry::get('sdCases');
        $name=$sdCases->find()
