...
<body>
    ...
    <div class="card text-center mx-auto my-3" style="width:85%;">
        <div class="card-header">
            <h4>Attachments and References</h4>
        </div>
        <div class="card-body">
            <!-- Add Document Modal -->
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <button id="addNewAttach" type="button" class="btn btn-outline-primary mb-3 float-left"><i class="fas fa-folder-plus"></i> Add New</button>
