...
class SdCompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'company_abbreviation' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_whodra' => 1,
                'create_by' => 1,
                'created_dt' => '2021-09-01 04:27:00',
                'modify_by' => 1,
                'modified_dt' => '2021-09-01 04:27:00',
